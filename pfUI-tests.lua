...
modules["cmatch"] = function()
  local tests = {
    ...
    { name = "SPELLLOGCRITSCHOOLOTHEROTHER (ruRU)", str = "\"SECOND\" FIRST наносит THIRD FOURTH ед. урона (FIFTH): критический эффект.", pat = "\"%2$s\" %1$s наносит %3$s %4$d ед. урона (%5$s): критический эффект." },
  }
  ...
  for _, test in pairs(tests) do
    ...
    print("values: |r%1=" .. ( first and ( first == "FIRST" and "|cff33ffcc"..first or "|cffff5555" .. first ) or "nil" ) .. "|cffaaaaaa :: |r" ..
                      "%2=" .. ( second and ( second == "SECOND" and "|cff33ffcc"..second or "|cffff5555" .. second ) or "nil" ) .. "|cffaaaaaa :: |r" ..
                      "%3=" .. ( third and ( third == "THIRD" and "|cff33ffcc"..third or "|cffff5555" .. third ) or "nil" ) .. "|cffaaaaaa :: |r" ..
                      "%4=" .. ( fourth and ( fourth == "FOURTH" and "|cff33ffcc"..fourth or "|cffff5555" .. fourth ) or "nil" ) .. "|cffaaaaaa :: |r" ..
                      "%5=" .. ( fifth and ( fifth == "FIFTH" and "|cff33ffcc"..fifth or "|cffff5555" .. fifth ) or "nil" ))
    if ( first and first == "FIRST" or first == nil ) and
    ( second and second == "SECOND" or second == nil ) and
    ( third and third == "THIRD" or third == nil ) and
    ( fourth and fourth == "FOURTH" or fourth == nil ) and
    ( fifth and fifth == "FIFTH" or fifth == nil ) then
